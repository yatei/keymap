 ...
 * |------+------+------+------+------+------+------|      |------+------+------+------+------+------+------|
 * | Esc  | GUI  | Alt  | Lower| Bksp | Space| Enter|      | Bksp | Space| GUI  | Alt  | Left | Right| Down |
 * `------------------------------------------------'      `------------------------------------------------'
 */
  [_QWERTY] = KEYMAP(
...
KC_ESC,KC_LGUI,KC_LALT ,LOWER  ,KC_BSPC,KC_SPC,KC_ENT , KC_BSPC,KC_SPC,KC_RGUI,KC_RALT,KC_LEFT,KC_RGHT,KC_DOWN
  ),
